...
//  }
  ...
  internal func setup(with source: NSDictionary?, completionHandler: @escaping (_ completed: Bool,_ player: AVPlayer) -> Void) {
    ...
    completionHandler(true, strongPlayer)
...
//  deinit {
//    appConfig.log( "[MediaPlayerLayerManager] Deinitialized.")
//    detachPlayer()
//  }
}
